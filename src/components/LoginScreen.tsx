  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (err?.code === "auth/unauthorized-domain" || msg.includes("auth/unauthorized-domain")) {
        ...
        setError(
          isAr
            ? `النطاق الحالي (${window.location.hostname}) غير مضاف في النطاقات المصرح بها في Firebase. أضف النطاق إلى Firebase ثم أعد المحاولة.`
            : `Current domain (${window.location.hostname}) is not authorized in Firebase Console. Add the domain in Firebase and try again.`
        );
      } else {
