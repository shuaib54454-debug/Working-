            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] text-amber-700 mt-1 leading-relaxed">
                  {isAr
                    ? "لتفادي هذا الخطأ، فعّل مزود Email/Password في Firebase أو استخدم حساب Google المعتمد:"
                    : "To resolve this, enable Email/Password in Firebase or use the verified Google Account:"}
                </p>
              </div>
            </div>
